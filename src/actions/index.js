  ...
  try {
    switch (action) {
      ...
      case 'look': case 'see': {
        ...
        const { hasLineOfSight, TRANSPARENT } = require('../perception/vision')
      ...
      case 'scan': {
        const { castVisionRays, formatVision, dirToYaw } = require('../perception/vision')
        const { upsertVisionChunked } = require('../world/memory')
        const { debugChat } = require('../core/utils')
      ...
      case 'view': case 'survey': {
        ...
        const { surveyVisible, formatSurvey } = require('../perception/visibility')
        const { debugChat } = require('../core/utils')
